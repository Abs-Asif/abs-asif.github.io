...
export default function NewsOriginIndex() {
  ...
  useEffect(() => {
    document.title = "NEWSOrigin | CORS Proxy";
  ...
  }/api/get?url=${encodeURIComponent(url)}");\nconst result = await response.json();`;
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (contentType && contentType.includes("application/json")) {
        ...
        setMetadata({ title: "Image Proxy Result", image: getApiUrl(`/api/get?url=${encodeURIComponent(validUrl.toString())}`) });
      } else {
      ...
      <main className="flex-grow flex flex-col items-center gap-6 p-4 pt-10 sm:gap-12 sm:p-12 md:p-24">
        ...
        <div className="w-full max-w-4xl flex justify-between items-center">
            ...
            <div className="flex gap-4 text-xs font-bold uppercase tracking-widest opacity-50">
                <Link to="/tools/newsorigin" className="text-blue-600 dark:text-blue-400">News</Link>
        ...
        <div className="w-full max-w-4xl">
            ...
            <div className="rounded-xl border border-neutral-200 bg-white p-5 sm:p-6 shadow-md dark:border-neutral-800 dark:bg-neutral-900">
                ...
                GET /api/get?url=example.com/image.png
                </div>
            </div>
            <div className="rounded-xl border border-neutral-200 bg-white p-5 sm:p-6 shadow-md dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div className="rounded-xl border border-neutral-200 bg-white p-5 sm:p-6 shadow-md dark:border-neutral-800 dark:bg-neutral-900 sm:col-span-2 lg:col-span-1">
                ...
                <div className="rounded bg-neutral-100 p-3 text-xs font-mono dark:bg-neutral-800 overflow-x-auto">
                <pre>GET /api/get?url=...&fields=title,favicon</pre>
                </div>
            </div>
            </div>
        </div>
